                ...
                <div className="form_data max-w-md w-full mx-auto p-6 bg-white shadow-md rounded flex flex-col items-center">
                    ...
                    <form className="w-full">
                        <div className="form_input">
                            <label htmlFor="name" className="block font-semibold text-gray-700 text-sm mb-2">Name</label>
                            <input type="text" onChange={setVal} value={inpval.name} name="name" id="name" className="w-full px-3 py-2 border rounded outline-none text-gray-700 leading-tight focus:border-blue-500 mb-3" placeholder="Enter Your Name" />
                        </div>
                        <div className="form_input">
                        ...
                        <div className="form_input">
                            <label htmlFor="password1" className="block font-semibold text-gray-700 text-sm mb-2">Password</label>
                            <div className="two relative">
                                <input type={!passShow ? "password" : "text"} value={inpval.password1} onChange={setVal} name="password1" id="password1" className="w-full px-3 py-2 border rounded outline-none text-gray-700 leading-tight focus:border-blue-500 mb-3" placeholder="Enter Your Password" />
                        ...
                        <div className="form_input">
                            <label htmlFor="password2" className="block font-semibold text-gray-700 text-sm mb-2">Confirm Password</label>
                            <div className="two relative">
                                <input type={!cpassShow ? "password" : "text"} value={inpval.password2} onChange={setVal} name="password2" id="password2" className="w-full px-3 py-2 border rounded-lg outline-none text-gray-700 leading-tight focus:border-blue-500 mb-6" placeholder="Confirm Password" />
